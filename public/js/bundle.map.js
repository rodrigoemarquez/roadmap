parcelRequire = (function(e, r, t, n) {
...
})(
  {
      ...
      function(require, module, exports) {
        ...
        var o = function(o) {
          ...
          var e = new mapboxgl.Map({
              container: 'map',
              style:
                'mapbox://styles/rodrigoemarquez/clbpqcdmu001a14o46x2vq20q',
              scrollZoom: !1
            }),
    ...
    BCHI: [
        ...
        function i() {
          ...
          function l(t, r, e, o) {
            var i = r && r.prototype instanceof v ? r : v,
              a = Object.create(i.prototype),
              u = new S(o || []);
            return n(a, '_invoke', { value: E(t, e, u) }), a;
          }
          function h(t, r, e) {
            try {
              return { type: 'normal', arg: t.call(r, e) };
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        'success' === e.sent.data.status &&
                          ((0, r.showAlert)('success', 'Sign up successfully!'),
                          window.setTimeout(function() {
                            location.assign('/me');
                          }, 1500)),
                          (e.next = 10);
      ...
      { axios: 'uj17', './alerts': 'odIX', './login': 'mnjM' }
    ],
    FxPS: [
      function(require, module, exports) {
        'use strict';
    ...
    Focm: [
      function(require, module, exports) {
        ...
        function u() {
          ...
          var v = (y.prototype = f.prototype = Object.create(h));
          function b(e) {
            ['next', 'throw', 'return'].forEach(function(r) {
              l(e, r, function(e) {
                  ...
                  return new r(function(o, i) {
                    !(function s(o, u, i, c) {
                      ...
                      if ('throw' !== a.type) {
                        var l = a.arg,
                          d = l.value;
                        return d && 'object' == n(d) && t.call(d, '__await')
          ...
          function E(e, r) {
            ...
            var o = m(s, e.iterator, r.arg);
            if ('throw' === o.type)
              return (
                (r.method = 'throw'), (r.arg = o.arg), (r.delegate = null), j
              );
            var n = o.arg;
            return n
              ? n.done
          ...
          return (
            (p.prototype = y),
            s(v, 'constructor', { value: y, configurable: !0 }),
            s(y, 'constructor', { value: p, configurable: !0 }),
            (p.displayName = l(y, a, 'GeneratorFunction')),
            ...
            (e.mark = function(e) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((e.__proto__ = y), l(e, a, 'GeneratorFunction')),
        ...
        if (a) {
          var y = JSON.parse(a.dataset.locations);
          (0, e.displayMap)(y);
        }
        l && console.log('Hello from LOGIN form'),
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              ...
                              (t = document.getElementById('password-current')
                                .value),
                              (o = document.getElementById('password').value),
                              (n = document.getElementById('password-confirm')
                                .value),
                              (e.next = 7),
                              (0, s.updateSettings)(
                                {
...
//# sourceMappingURL=/bundle.map.js.map
