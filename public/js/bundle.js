...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicm9kcmlnb2VtYXJxdWV6IiwiYSI6ImNsYnBxNWN5YzA3MHkzb3A5bWFsZ2NqNXMifQ.m5hBSsiRjTV_GUbXj9fMlw';
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, emailConfirm, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
/* eslint-disable */
var stripe = Stripe('pk_test_51MIfYYIHeZaJpU0ELb0QI41fz46ZEQOYIbPefOvrbR3fe0HXFICYvavShaTnOBVP4WycrsldwEpGKyncionsN6lj00nXCvv6Ni');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  document.querySelector('.btn--small.btn--green').textContent = 'Updating...';
  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  form.append('email', document.getElementById('email').value);
  form.append('emailConfirm', document.getElementById('emailConfirm').value);
  form.append('photo', document.getElementById('photo').files[0]);
  (0, _updateSettings.updateSettings)(form, 'data');
  document.querySelector('.btn--small.btn--green').textContent = 'Save settings';
});
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(name, email, emailConfirm, password, passwordConfirm);
  });
}
